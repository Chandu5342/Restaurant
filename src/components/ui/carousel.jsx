...
const Carousel = React.forwardRef(({ orientation = "horizontal", opts, setApi, plugins, className, children, ...props }, ref) => {
  ...
  const onSelect = React.useCallback(() => {
    if (!api) return;
    setCanScrollPrev(!!api.canScrollPrev && api.canScrollPrev());
    setCanScrollNext(!!api.canScrollNext && api.canScrollNext());
  }, [api]);
  ...
  const contextValue = { carouselRef, api, scrollPrev, scrollNext, canScrollPrev, canScrollNext, orientation };
