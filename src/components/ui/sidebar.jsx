 ...
 *  - className, style
 */
export const SidebarProvider = React.forwardRef((props, ref) => {
  const {
    children,
    className,
    style,
    ...
    <SidebarContext.Provider value={contextValue}>
      <Tooltip.Provider delayDuration={0}>
        <div
          ...
          className={cn("group/sidebar-wrapper flex min-h-[100svh] w-full", className)}
          {...rest}
        >
          {children}
        </div>
...
/* -----------------------
   SidebarInset (main content area when sidebar is inset)
   ----------------------- */
...
/* Header / Footer / Separator / Content / Group primitives */
export const SidebarHeader = React.forwardRef((props, ref) => {
  const { className, ...rest } = props;
  return <div ref={ref} data-sidebar="header" className={cn("flex flex-col gap-2 p-2", className)} {...rest} />;
});
SidebarHeader.displayName = "SidebarHeader";

export const SidebarFooter = React.forwardRef((props, ref) => {
  const { className, ...rest } = props;
  return <div ref={ref} data-sidebar="footer" className={cn("flex flex-col gap-2 p-2", className)} {...rest} />;
});
SidebarFooter.displayName = "SidebarFooter";

export const SidebarSeparator = React.forwardRef((props, ref) => {
  const { className, ...rest } = props;
  return <Separator ref={ref} data-sidebar="separator" className={cn("mx-2 w-auto bg-sidebar-border", className)} {...rest} />;
});
SidebarSeparator.displayName = "SidebarSeparator";

export const SidebarContent = React.forwardRef((props, ref) => {
  const { className, ...rest } = props;
  return (
    <div
      ref={ref}
...
export const SidebarGroup = React.forwardRef((props, ref) => {
  const { className, ...rest } = props;
  return (
...
/* SidebarGroupLabel - supports asChild via Slot */
export const SidebarGroupLabel = React.forwardRef((props, ref) => {
  ...
  return (
    <Comp
      ...
      className={cn(
        "flex h-8 shrink-0 items-center rounded-md px-2 text-xs font-medium text-sidebar-foreground/70 outline-none ring-sidebar-ring transition-[margin,opa] duration-200 ease-linear focus-visible:ring-2 [&>svg]:h-4 [&>svg]:w-4 [&>svg]:shrink-0",
...
/* SidebarGroupAction */
export const SidebarGroupAction = React.forwardRef((props, ref) => {
  const { className, asChild = false, ...rest } = props;
...
export const SidebarGroupContent = React.forwardRef((props, ref) => {
  const { className, ...rest } = props;
...
/* -----------------------
   Menu primitives
   ----------------------- */
export const SidebarMenu = React.forwardRef((props, ref) => {
  const { className, ...rest } = props;
 ...
 *  - variant, size
 */
export const SidebarMenuButton = React.forwardRef((props, ref) => {
  let { asChild = false, isActive = false, variant = "default", size = "default", tooltip, className, ...rest } = props;
  const Comp = asChild ? Slot : "button";
...
export const SidebarMenuAction = React.forwardRef((props, ref) => {
...
/* Menu badge */
export const SidebarMenuBadge = React.forwardRef((props, ref) => {
  const { className, ...rest } = props;
  return (
    <div
      ref={ref}
...
/* Menu skeleton (for loading) */
export const SidebarMenuSkeleton = React.forwardRef((props, ref) => {
...
/* Menu sub-list and items */
export const SidebarMenuSub = React.forwardRef((props, ref) => {
  const { className, ...rest } = props;
  return (
    <ul
      ref={ref}
...
export const SidebarMenuSubButton = React.forwardRef((props, ref) => {
  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        isActive && "data-[active=true]:bg-sidebar-accent data-[active=true]:text-sidebar-accent-foreground",
        size === "sm" && "text-xs",
        size === "md" && "text-sm",
        "group-data-[collapsible=icon]:hidden",
        className
